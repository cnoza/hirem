...
model_xgb <- hirem(reserving_data) %>%
  ...
  layer_xgb('settlement', objective = 'binary:logistic',
            eval_metric = 'logloss',
            bayesOpt = F, #bayesOpt_min = T, bayesOpt_iters_n = 5, bayesOpt_bounds = bounds, bayesOpt_initPoints = 10,
            eta = 1, max_depth = 1,
...
model_dnn <-  hirem(reserving_data) %>%
  ...
  layer_dnn('settlement', distribution = 'bernoulli',
            bayesOpt = T, bayesOpt_min = T, bayesOpt_iters_n = 1, bayesOpt_bounds = bounds, bayesOpt_initPoints = 10, nfolds = 1,
            #hidden = c(20,50,30),
