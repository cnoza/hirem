...
res.tab.settle <- covariate_selection('settlement', all_covariates, family.settle, d, weight)
...
res.tab.pay <- covariate_selection('payment',all_covariates, family.pay, d, weight)
print(res.tab.pay)
...
res.tab.size <- covariate_selection('size',all_covariates, family.size, d_size, weight)
print(res.tab.size)
