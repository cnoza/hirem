---
title: "Testing the hierarchical reserving models on a simulated portfolio (extreme scenario)"
...
## Introduction
This version of this document extends a previous one written by Jens Robben, in which hierarchical GLM and hierarchical GBM are compared. In the present version, we add the hierarchical XGB, hierarchical DNN and hierarchical CANN models to the comparison.
