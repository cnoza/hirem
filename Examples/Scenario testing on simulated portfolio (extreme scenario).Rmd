...
## Introduction
This version of this document extends a previous one written by Jens Robben, in which hierarchical GLM and hierarchical GBM are compared. In the present version, hierarchical XGB, hierarchical DNN and hierarchical CANN are further considered.
