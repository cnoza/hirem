...
model_xgb <- fit(model_xgb,
                 settlement = paste0('settlement ~ 1 + ', paste0(covariates_xgb, collapse = ' + ')),
                 payment = paste0('payment ~ 1 + ', paste0(c(covariates_xgb, 'settlement'), collapse = ' + ')),
                 size = paste0('size ~ 1 + ', paste0(c(covariates_xgb,'settlement'), collapse = ' + ')))
```
