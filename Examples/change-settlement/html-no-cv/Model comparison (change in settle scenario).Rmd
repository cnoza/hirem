---
title: "Model comparison (change in settlement scenario)"
...
We now generate partial dependence plots. For this, we consider a portfolio generated with seed 1. All models were trained based on the "Change settle with seed param.Rmd" file before executing the code below. 
