...
files <- list.files(path = "./Examples/baseline/html-no-cv/",pattern = ".html")
...
for(i in seq_along(files)) {
  ...
  page <- read_html(paste0('./Examples/baseline/html-no-cv/',files[i]))
...
write_csv(df.settle,'./Examples/baseline/html-no-cv/results-simulation-baseline-settlements.csv')
write_csv(df.pay,'./Examples/baseline/html-no-cv/results-simulation-baseline-payments.csv')
write_csv(df.size,'./Examples/baseline/html-no-cv/results-simulation-baseline-sizes.csv')
