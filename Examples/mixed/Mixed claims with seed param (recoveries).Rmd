---
title: "Testing the hierarchical reserving models on the simulation engine including recoveries (mixed claims scenario)"
...
## Introduction
This document implements hierarchical reserving models based on the extended hirem package. 
...
reserving_data <- simulate_scenario_claim_mix(seed = seed, n = 125000, gen.recoveries = TRUE, prob.Hidden.recov = c(.1,.2,.3))
