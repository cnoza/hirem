---
title: "Testing the hierarchical reserving models on a simulated portfolio (mixed scenario)"
...
gbm_param_settle <- list('n.trees' = 50, 'interaction.depth' = 2, 'shrinkage' = 0.2)
gbm_param_pay    <- list('n.trees' = 100, 'interaction.depth' = 5, 'shrinkage' = 0.05)
gbm_param_size   <- list('n.trees' = 225, 'interaction.depth' = 1, 'shrinkage' = 0.1)
...
```{r}
# Results of hierarchical model calibration
xgb_param_settle <- list('eta' =   .1, 'max_depth' = 1, 'nrounds' =  468, 'subsample' = 1)
xgb_param_pay    <- list('eta' =  .3, 'max_depth' = 2, 'nrounds' =  34, 'subsample' = 1)
xgb_param_size   <- list('eta' = .2, 'max_depth' = 1, 'nrounds' = 311, 'subsample' = 1)
