...
setwd("~/R-projects/hirem/Examples")
...
# Print Results
c('Actual' =  obs_open_total, 'Chain-Ladder' = cl_open_total, 'Hierarchical GLM' = glm_open_total, 'Hierarchical GBM' = gbm_open_total, 'Hierarchical CANN/GLM' = cann_open_total, 'Hierarchical CANN/GBM' = cann2_open_total)
```
...
# Print Results
c('Actual' = obs_pay_total, 'Chain-Ladder' = cl_pay_total, 'Hierarchical GLM' = glm_pay_total, 'Hierarchical GBM' = gbm_pay_total, 'Hierarchical CANN/GLM' = cann_pay_total, 'Hierarchical CANN/GBM' = cann2_pay_total)
```
...
# Print Results
c('Actual' = obs_recov_total, 'Hierarchical GLM' = glm_recov_total, 'Hierarchical GBM' = gbm_recov_total, 'Hierarchical CANN/GLM' = cann_recov_total, 'Hierarchical CANN/GBM' = cann2_recov_total)
```
...
# Print Results
c('Actual' = obs_size_pay_total, 'Chain-Ladder' = cl_size_pay_total, 'Hierarchical GLM' = glm_size_pay_total, 'Hierarchical GBM' = gbm_size_pay_total, 'Hierarchical CANN/GLM' = cann_size_pay_total, 'Hierarchical CANN/GBM' = cann2_size_pay_total)
```
...
# Print Results
c('Actual' = obs_size_recov_total, 'Hierarchical GLM' = glm_size_recov_total, 'Hierarchical GBM' = gbm_size_recov_total, 'Hierarchical CANN/GLM' = cann_size_recov_total, 'Hierarchical CANN/GBM' = cann2_size_recov_total)
```
