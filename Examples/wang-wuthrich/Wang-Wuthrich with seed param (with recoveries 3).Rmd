...
formula_recov_glm <- "recovery ~ devYearMonth + settlement + type + age.fact + rep.month"
...
formula_size_recov_glm <- "q.size.recov ~ age.fact + devYearMonth + rep.month + type + settlement"
```
