...
#reserving_data$monthDev12 <- as.character(ceiling(as.numeric(reserving_data$rep.month)/3))
...
# reserving_data$devYearMonth <- paste(reserving_data$dev.year, reserving_data$monthDev12, sep = '-')
# reserving_data$devYearMonth[reserving_data$devYearMonth == '9-dev.year.over.3'
#                             | reserving_data$devYearMonth == '10-dev.year.over.3'] <- '9-10-dev.year.over.3'
# reserving_data$devYearMonth <- factor(reserving_data$devYearMonth)
...
formula_settle_glm <- "settlement ~ type + devYearMonth + rep.month + age.fact"
#formula_pay_glm    <- res.tab.pay$m_formula[[1]]
formula_pay_glm <- "payment ~ settlement + devYearMonth + type + age.fact + rep.month"
#formula_recov_glm    <- res.tab.recov$m_formula[[1]]
formula_recov_glm <- "recovery ~ settlement + devYearMonth + type + age.fact + rep.month"
#formula_size_pay_glm   <- res.tab.size.pay$m_formula[[1]]
formula_size_pay_glm <- "size.pay ~ type + devYearMonth + settlement + age.fact + rep.month"
#formula_size_recov_glm    <- res.tab.size.recov$m_formula[[1]]
formula_size_recov_glm <- "q.size.recov ~ type + devYearMonth + age.fact + rep.month + settlement"
```
...
# Print Results
c('Actual' =  obs_open_total, 'Chain-Ladder' = cl_open_total, 'Hierarchical GLM' = glm_open_total, 'Hierarchical GBM' = gbm_open_total, 'Hierarchical CANN/GLM' = cann_open_total)
```
...
# Print Results
c('Actual' = obs_pay_total, 'Chain-Ladder' = cl_pay_total, 'Hierarchical GLM' = glm_pay_total, 'Hierarchical GBM' = gbm_pay_total, 'Hierarchical CANN/GLM' = cann_pay_total)
```
...
# Print Results
c('Actual' = obs_recov_total, 'Hierarchical GLM' = glm_recov_total, 'Hierarchical GBM' = gbm_recov_total, 'Hierarchical CANN/GLM' = cann_recov_total)
```
...
# Print Results
c('Actual' = obs_size_pay_total, 'Chain-Ladder' = cl_size_pay_total, 'Hierarchical GLM' = glm_size_pay_total, 'Hierarchical GBM' = gbm_size_pay_total, 'Hierarchical CANN/GLM' = cann_size_pay_total)
```
...
# Print Results
c('Actual' = obs_size_recov_total, 'Hierarchical GLM' = glm_size_recov_total, 'Hierarchical GBM' = gbm_size_recov_total, 'Hierarchical CANN/GLM' = cann_size_recov_total)
```
