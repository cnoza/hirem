...
#' 
#' This function calculates the development factors of a cumulative run-off triangle and performs the chain-ladder prediction.
#'
...
#' Special version of the chain-ladder model for the incremental run-off triangle of the number of open claims.
#' 
#' This function applies a special version of the chain-ladder model for the incremental run-off triangle of the number of open claims.
#' 
#' @param triangle The incremental run-off triangle of the number of open claims.
#' 
#' @export
